...
struct linalg_Vec4 linalg_Vec4_add(struct linalg_Vec4 v0,
...
struct linalg_Vec4 linalg_Vec4_matmul(struct linalg_Vec4 v,
                                      struct linalg_Mat4x4 *mat); /* TODO */
...
void linalg_Mat4x4_matmul(struct linalg_Mat4x4 *left,
                          struct linalg_Mat4x4 *right);
